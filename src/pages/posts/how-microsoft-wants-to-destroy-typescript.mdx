...
즉, Microsoft의 TypeScript가 갑작스레 매우 실용적인 도구에서 다소 성가신 도구로 바뀌었다는 것을 의미합니다. Microsoft는 장애물이 되고 싶어하지 않고, 그 대신 개발자들에게 영감을 주고 싶어합니다.
...
저는 이 제안으로 자바스크립트와 타입스크립트의 실제 구분이 보이지 않습니다. 그리고 이것이 미래가 되는 것이 맞는지 의심스럽습니다.
